    ...
    <div class="container">
       <div class="row">
          <div class="col-lg-12 col-sm-12">
             <div class="row contact-detail text-center">
                <div class="col-md-4">
                   ...
                   <div class="icon-box-content">
                      ...
                      <p class="icon-box-description">Brooklyn, New York</p>
                   </div>
                </div>
                <div class="col-md-4">
                   <div class="iq-contact-list" data-element_type="column">
                      <div class="icon-box">
                         <span class="icon-svg icon-svg d-flex justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Capa_2" x="0px" y="0px" viewBox="0 0 473.806 473.806" style="enable-background:new 0 0 473.806 473.806;" xml:space="preserve">
                               <g>
                                  <g>
                      ...
                      <div class="icon-box-content">
                         ...
                         <p class="icon-box-description">+0123-456789</p>
                      </div>
                   </div>
                </div>
                <div class="col-md-4">
                   <div class="iq-contact-list" data-element_type="column">
                      <div class="icon-box">
                         <span class="icon-svg icon-svg d-flex justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Capa_3" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                               <g>
                                  <g>
                      ...
                      <div class="icon-box-content">
                         ...
                         <p class="icon-box-description">support@streamit.com</p>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div class="wrapper">
                <form action="/wp-themes/streamit_wp/contact/#wpcf7-f6-p5048-o1" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
